...
@section('content')
	<div class="nav_menu">
		@component('regpanel.panel.components.breadcrumb')
			@slot('title') Добавление новой должности @endslot
			@slot('parent') Главная @endslot
			@slot('position') Список должностей @endslot
			@slot('active') Создание должности @endslot
		@endcomponent
	</div>
	...
	<section class="content">
		<div class="row">
              <div class="col-md-12 col-sm-12 ">
                <form method="POST" action="{{route('regpanel.panel.positions.store', $item->id)}}" data-toggle="validator">
                @csrf
                <div class="x_panel">
                  <div class="x_title">
