...
<div class="box box-info">
			...
			<table class="table no-margin">
				...
				@foreach($last_orders as $order)
					<tr>
						...
						@endif
						@if($order->status == 2)<b style="...">Удален</b>
						@endif
						</span></td>
					<td>
						<div class="sparkbar" data-color="#00a65a" data-heigth="20">{{$order->sum}}</div>
					</td>
					</tr>
				@endforeach
				</tbody>
	...
	<div class="box-footer clearfix">
		<a href="{{route('blog.admin.orders.index')}}" class="btn btn-sm btn-info btn-first pull-left">Все заказы</a>
	</div>
	<!--/.box-footer -->
</div>
<!--/.box-->
