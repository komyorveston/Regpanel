<div class="box box-danger box-solid">
	...
	<div class="box-body" id="image" style="border: 1px solid whitesmoke; text-align: center; position: relative">
		...
		@else
			<img width="50%" height="50%" src='{{asset("/uploads/single/$organization->img")}}' id="preview_image" />
		@endif
	...
	<p style="text-align: center">
		...
		@else
			<a href="javascript:removeFileImg()" style="color: red; text-decoration: none;" class="myimg" data-name="{{$organization->img}}">
				<i class="glyphicon glyphicon-trash"></i>Удалить
			</a>
		@endif
	</p>
